      ...
      <div id="base-header" class="base">
          ...
          <div class="row">
            <div class="col s3 offset-s1">
                  ...
                  ?>
                  <a class='dropdown-button btn btn-flat headText' data-hover='false' href='#' data-activates='dropdownMenuLanguage'><?php echo($lang); ?></a>

                  <!-- Dropdown Structure -->
                  <ul id='dropdownMenuLanguage' class='dropdown-content z-depth-1 waves-teal'>
                    <li><a href="<?php echo '/it'.($_SERVER['PHP_SELF'])?>">Italiano</a></li>
                    <li><a href="<?php echo '/en'.($_SERVER['PHP_SELF'])?>">English</a></li>
                  </ul>

            </div>
            <div class="col s5 "><div class="headText right"><?php if ( is_user_logged_in() ) { ?>
        ...
        <?php // to use a image just replace the bloginfo('name') with your img src and remove the surrounding <p> ?>
          ...
          <div class="row">
            <div class="col s2 offset-s1">
              <i class="small material-icons">view_headline</i></div>
              <div class="col s6 ">
